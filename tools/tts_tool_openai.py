...
def _generate_openai_tts(
    ...
    if instructions is None:
        # Lera: optional style/accent instructions for gpt-4o-mini-tts, from
        # tts.openai.instructions. An explicit argument still wins.
        instructions = str(oai_config.get("instructions") or "").strip() or None
