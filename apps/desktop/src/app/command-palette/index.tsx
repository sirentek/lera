  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        // Lera: no enter/exit animation on the palette. Unmount then falls to
        // CommandPalette's EXIT_FALLBACK_MS timer, which exists for exactly
        // this case (`animation: none`) — onAnimationEnd never fires.
        className={cn(
          HUD_POSITION,
          HUD_SURFACE,
          'z-(--z-over-modal-content) w-[min(34rem,calc(100vw-2rem))] overflow-hidden'
        )}
